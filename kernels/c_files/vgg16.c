...
#define S48(i,j,k,l,m,n,o) {total++; printf("S48 %d %d %d %d %d %d %d\n",i,j,k,l,m,n,o);}
...
#define S54(i,j,k,l,m,n) {total++; printf("S54 %d %d %d %d %d %d\n",i,j,k,l,m,n);}
#define S55(i,j,k,l) {total++; printf("S55 %d %d %d %d\n",i,j,k,l);}
#define S56(i,j,k,l,m,n) {total++; printf("S56 %d %d %d %d %d %d\n",i,j,k,l,m,n);}
...
#define S61(i,j) {total++; printf("S61 %d %d\n",i,j);}
#define S62(i,j) {total++; printf("S62 %d %d\n",i,j);}
#define S63(i,j,k) {total++; printf("S63 %d %d %d\n",i,j,k);}
#define S64(i,j) {total++; printf("S64 %d %d\n",i,j);}
#define S65(i,j) {total++; printf("S65 %d %d\n",i,j);}
...
int main() {
  ...
  double A50[2000][2000];
  double A35[2000][2000][2000][2000];
  double A55[2000][2000];
  ...
  double A53[2000][2000];
  double A36[2000][2000][2000][2000];
  double A33[2000][2000][2000][2000];
  double A52[2000][2000];
  double A51[2000][2000];
  double A58[2000][2000];
  double A37[2000][2000][2000][2000];
  double A56[2000][2000];
...
#pragma scop
      ...
      for (c6=0;c6<=55;c6++) {
        for (c8=0;c8<=55;c8++) {
          for (c10=0;c10<=255;c10++) {
            for (c12=0;c12<=2;c12++) {
              for (c14=0;c14<=2;c14++) {
                A18[c2][c4][c6][c8] = A18[c2][c4][c6][c8] + A25[c2][c10][c6+c12][c8+c14] + A26[c4][c10][c12][c14];
              }
            }
          }
        }
    ...
    for (c4=0;c4<=255;c4++) {
      for (c6=0;c6<=27;c6++) {
        for (c8=0;c8<=27;c8++) {
          for (c10=0;c10<=1;c10++) {
            for (c12=0;c12<=1;c12++) {
              A27[c2][c4][c6][c8] = A27[c2][c4][c6][c8] + A21[c2][c4][2*(c6)+c10][2*(c8)+c12];
            }
          }
        }
      }
      ...
      for (c6=0;c6<=27;c6++) {
        for (c8=0;c8<=27;c8++) {
          for (c10=0;c10<=255;c10++) {
            for (c12=0;c12<=2;c12++) {
              for (c14=0;c14<=2;c14++) {
                A30[c2][c4][c6][c8] = A30[c2][c4][c6][c8] + A28[c2][c10][c6+c12][c8+c14] + A31[c4][c10][c12][c14];
              }
            }
          }
        }
  ...
  for (c2=0;c2<=63;c2++) {
    for (c4=0;c4<=511;c4++) {
      for (c6=0;c6<=27;c6++) {
        for (c8=0;c8<=27;c8++) {
          A32[c2][c4][c6][c8] = A30[c2][c4][c6][c8];
        }
      }
    }
  }
      ...
      for (c6=0;c6<=27;c6++) {
        for (c8=0;c8<=27;c8++) {
          for (c10=0;c10<=511;c10++) {
            for (c12=0;c12<=2;c12++) {
              for (c14=0;c14<=2;c14++) {
                A34[c2][c4][c6][c8] = A34[c2][c4][c6][c8] + A33[c2][c10][c6+c12][c8+c14] + A35[c4][c10][c12][c14];
              }
            }
          }
        }
      ...
      for (c6=0;c6<=27;c6++) {
        for (c8=0;c8<=27;c8++) {
          for (c10=0;c10<=511;c10++) {
            for (c12=0;c12<=2;c12++) {
              for (c14=0;c14<=2;c14++) {
                A29[c2][c4][c6][c8] = A29[c2][c4][c6][c8] + A36[c2][c10][c6+c12][c8+c14] + A37[c4][c10][c12][c14];
              }
            }
          }
        }
  ...
  for (c2=0;c2<=63;c2++) {
    for (c4=0;c4<=511;c4++) {
      for (c6=0;c6<=27;c6++) {
        for (c8=0;c8<=27;c8++) {
          A32[c2][c4][c6][c8] = A29[c2][c4][c6][c8];
        }
      }
    }
  }
    ...
    for (c4=0;c4<=511;c4++) {
      for (c6=0;c6<=13;c6++) {
        for (c8=0;c8<=13;c8++) {
          for (c10=0;c10<=1;c10++) {
            for (c12=0;c12<=1;c12++) {
              A38[c2][c4][c6][c8] = A38[c2][c4][c6][c8] + A32[c2][c4][2*(c6)+c10][2*(c8)+c12];
            }
          }
        }
      }
      ...
      for (c6=0;c6<=13;c6++) {
        for (c8=0;c8<=13;c8++) {
          for (c10=0;c10<=511;c10++) {
            for (c12=0;c12<=2;c12++) {
              for (c14=0;c14<=2;c14++) {
                A41[c2][c4][c6][c8] = A41[c2][c4][c6][c8] + A39[c2][c10][c6+c12][c8+c14] + A42[c4][c10][c12][c14];
              }
            }
          }
        }
  ...
  for (c2=0;c2<=63;c2++) {
    for (c4=0;c4<=511;c4++) {
      for (c6=0;c6<=13;c6++) {
        for (c8=0;c8<=13;c8++) {
          A38[c2][c4][c6][c8] = A41[c2][c4][c6][c8];
        }
      }
    }
  }
      ...
      for (c6=0;c6<=13;c6++) {
        for (c8=0;c8<=13;c8++) {
          for (c10=0;c10<=511;c10++) {
            for (c12=0;c12<=2;c12++) {
              for (c14=0;c14<=2;c14++) {
                A44[c2][c4][c6][c8] = A44[c2][c4][c6][c8] + A43[c2][c10][c6+c12][c8+c14] + A45[c4][c10][c12][c14];
              }
            }
          }
        }
  ...
  for (c2=0;c2<=63;c2++) {
    for (c4=0;c4<=511;c4++) {
      for (c6=0;c6<=13;c6++) {
        for (c8=0;c8<=13;c8++) {
          A38[c2][c4][c6][c8] = A44[c2][c4][c6][c8];
        }
      }
    }
  }
      ...
      for (c6=0;c6<=13;c6++) {
        for (c8=0;c8<=13;c8++) {
          for (c10=0;c10<=511;c10++) {
            for (c12=0;c12<=2;c12++) {
              for (c14=0;c14<=2;c14++) {
                A40[c2][c4][c6][c8] = A40[c2][c4][c6][c8] + A46[c2][c10][c6+c12][c8+c14] + A47[c4][c10][c12][c14];
              }
            }
          }
        }
  ...
  for (c2=0;c2<=63;c2++) {
    for (c4=0;c4<=511;c4++) {
      for (c6=0;c6<=13;c6++) {
        for (c8=0;c8<=13;c8++) {
          A38[c2][c4][c6][c8] = A40[c2][c4][c6][c8];
        }
      }
    }
  }
    ...
    for (c4=0;c4<=511;c4++) {
      for (c6=0;c6<=6;c6++) {
        for (c8=0;c8<=6;c8++) {
          for (c10=0;c10<=1;c10++) {
            for (c12=0;c12<=1;c12++) {
              A48[c2][c4][c6][c8] = A48[c2][c4][c6][c8] + A38[c2][c4][2*(c6)+c10][2*(c8)+c12];
            }
          }
        }
      }
  ...
  for (c2=0;c2<=63;c2++) {
    for (c4=0;c4<=511;c4++) {
      for (c6=0;c6<=6;c6++) {
        for (c8=0;c8<=6;c8++) {
          A49[c2][c4][c6][c8] = A49[c2][c4][c6][c8] + A48[c2][c4][c6+0][c8+0];
        }
      }
    }
  }
  ...
  for (c2=0;c2<=63;c2++) {
    for (c4=0;c4<=4095;c4++) {
      for (c6=0;c6<=25087;c6++) {
        A53[c2][c4] = A53[c2][c4] + A54[c2][c6] + A51[c6][c4];
      }
    }
  }
  for (c2=0;c2<=63;c2++) {
  ...
  for (c2=0;c2<=63;c2++) {
    for (c4=0;c4<=4095;c4++) {
      for (c6=0;c6<=4095;c6++) {
        A52[c2][c4] = A52[c2][c4] + A56[c2][c6] + A58[c6][c4];
      }
    }
  }
  for (c2=0;c2<=63;c2++) {
  ...
  for (c2=0;c2<=63;c2++) {
    for (c4=0;c4<=999;c4++) {
      for (c6=0;c6<=4095;c6++) {
        A62[c2][c4] = A62[c2][c4] + A56[c2][c6] + A61[c6][c4];
      }
    }
  }
  for (c2=0;c2<=63;c2++) {
