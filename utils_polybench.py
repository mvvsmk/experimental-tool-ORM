...
def build_polybench_kernels_energy_time(src_dir,build_dir,dataset, data_type="DATA_TYPE_IS_DOUBLE"):
...
def build_polybench_kernels_papi(src_dir, build_dir, dataset="LARGE_DATASET", data_type="DATA_TYPE_IS_DOUBLE"):
